...
class resnet():
  ...
  def resnet50(self, num_classes, dtype='float32', batch_size=None):
  ...
  def resnet101(self, num_classes, dtype='float32', batch_size=None):
    ...
    # Create model.
    return models.Model(img_input, x, name='resnet101')
  ...
  def resnet152(self, num_classes, dtype='float32', batch_size=None):
    ...
    # Create model.
    return models.Model(img_input, x, name='resnet152')