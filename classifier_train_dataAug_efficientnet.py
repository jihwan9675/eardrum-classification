...
def main():
	...
	for i in range(shuffled_train_images.shape[0]):
		...
		model.save_weights('Weight/BS32_efficientnet_KF5_013/KF'+str(i)+'Weight000120_Aug_eff_ji.h5')
		'''
		...
		history_location = 'history/BS32_efficientnet_KF5_013/KF'+str(i)+'_cv_history000120_train50_Aug_eff_ji.h5'
